...
public class EncriptacionAES implements Encriptacion {
    ...
    public String encriptar(String strToEncrypt, String secret) {
        try {
            ...
            SecretKeyFactory factory = SecretKeyFactory.getInstance(ConstantesSeguridad.PBKDF_2_WITH_HMAC_SHA_256);
            ...
            SecretKeySpec secretKey = new SecretKeySpec(tmp.getEncoded(), ConstantesSeguridad.AES);

            Cipher cipher = Cipher.getInstance(ConstantesSeguridad.AES_GCM_NO_PADDING);
